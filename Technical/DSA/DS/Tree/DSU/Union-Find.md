...
> **Nén đường dẫn qua thế hệ (Path Halving)**: Trong quá trình tìm kiếm, sau mỗi bước tìm kiếm, chúng ta di chuyển nút hiện tại trực tiếp đến ông nội của nó (nút cha của nút cha), từ đó giảm độ sâu của cây.
